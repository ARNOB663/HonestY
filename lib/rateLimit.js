...
// Accept either naming convention so this works whether you set the
// official Upstash vars or installed Vercel's Upstash/KV integration
// (which uses KV_REST_API_*).
function redisCreds() {
  const url =
